...
export function SectionSeparator({ position }: SectionSeparatorProps) {
  return (
    ...
    >
      <div
        className="relative left-1/2 aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-primary/70 to-secondary/70 opacity-30 sm:w-[72.1875rem]"
        style={{
          clipPath:
