...
import { Home, FileText, Briefcase, Settings, LogOut, Building, User, Handshake, ArrowDownCircle, ArrowUpCircle, Globe, GraduationCap, FileSignature } from 'lucide-react';
      ...
      <aside className="w-64 flex-shrink-0 border-r bg-card border-border/20 flex flex-col">
        <div className="h-20 flex items-center px-6 border-b border-border/20">
           <Link href="/" className="flex items-center gap-2">
            <Image src="https://iili.io/K78fXyb.png" alt="Evol-vance Logo" width={65} height={65} />
          </Link>
        </div>
