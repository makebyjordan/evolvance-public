           ...
           <CardHeader>
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <CardDescription>
                            Crea, edita y gestiona los documentos HTML para las propuestas de Julián.
                        </CardDescription>
                    </div>
                </div>
            </CardHeader>
           ...
           <CardHeader>
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <CardDescription>
                            Define y sigue el progreso de los objetivos para Julián.
                        </CardDescription>
                    </div>
                </div>
            </CardHeader>
            <CardContent>
                <ObjectivesClientPage owner="julian" />
            </CardContent>
        </Card>
      </TabsContent>
    </Tabs>
