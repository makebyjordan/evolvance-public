...
import { OfficeProtocolForm } from "./OfficeProtocolForm";
...
import { OfficeProtocolViewDialog } from "./OfficeProtocolViewDialog";

export function OfficeProtocolsClientPage() {
  ...
  return (
    <>
      ...
      <OfficeProtocolForm isOpen={isFormOpen} setIsOpen={setIsFormOpen} onFormSubmit={handleFormSubmit} protocol={selectedProtocol} />
      
      <OfficeProtocolViewDialog isOpen={isViewOpen} setIsOpen={setIsViewOpen} protocol={selectedProtocol} />
